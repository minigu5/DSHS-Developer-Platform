...
const DEMO_PROJECTS = [
  ...
  },
  {
    id: "4",
    title: "DSHS 알고리즘 튜터",
    short_description: "정보 시간 및 올림피아드 대비를 위한 맞춤형 알고리즘 문제 추천 및 해설 서비스.",
    description: "정보 시간 및 올림피아드 대비를 위한 맞춤형 알고리즘 문제 추천 및 해설 서비스. 상세 설명...",
    type: "Web App",
    platforms: ["Web"],
    author: "정보올림피아드 동아리",
  ...
  },
  {
    id: "5",
    title: "기숙사 룸메 매칭 시스템",
    short_description: "생활 패턴, 수면 시간 등을 분석하여 최적의 룸메이트를 추천해주는 서비스입니다.",
    description: "생활 패턴, 수면 시간 등을 분석하여 최적의 룸메이트를 추천해주는 서비스입니다. 상세 설명...",
    type: "Web App",
